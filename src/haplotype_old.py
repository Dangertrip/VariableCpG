...
def main():
    ...
    for line in f:
        ...
        strand_specific_table = strand_map[strand[0]]
        seq_err=False
        for num in cpg_arr: 
        ...
        if cpg_status:
            ...
            result.append(chr+'\t'+str(s)+'\t'+str(e-1)+'\t'+name+'\t'+cpg_status+'\t'+strand+'\t'+cpg_pos[:-1]+'\n')
